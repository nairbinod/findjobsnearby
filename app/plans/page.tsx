...
const title = "Plans & Pricing | Free Job Posting in Texas | FindJobsNearBy";
const description = "Post jobs and apply for free, always. Employers pay $2.99 only to unlock a candidate's full profile, or go Growth ($39.99/mo) for 25 included views, advanced search, and team tools.";

export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: "/plans" },
  openGraph: { type: "website", title, description, url: "/plans" },
...
export default function PlansPage() {
  const breadcrumb = breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Plans", path: "/plans" }]);
